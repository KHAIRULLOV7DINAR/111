...
index_first_negative.o:
	gcc -std=gnu99 index_first_negative.c

index_last_negative.o:
	gcc -std=gnu99 index_last_negative.c

multi_between_negative.o:
	gcc -std=gnu99 multi_between_negative.c

multi_before_and_after_negative.o:
	gcc -std=gnu99 multi_before_and_after_negative.c

console_input_opt.o:
	gcc -std=gnu99 console_input_opt.c

console_input_arr.o:
	gcc -std=gnu99 console_input_arr.c
